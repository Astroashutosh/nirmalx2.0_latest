...
function Cards({ totalWithdraw }) {
  ...
  const handleStake = async () => {
    try {
      ...
      console.log("paymentToken", typeof paymentToken, paymentToken)
        ...
        <div className="col-lg-4 col-md-4">
          <div className="farms-single-section gradient-border stakeBg">
            ...
            <div className="unlocks">
              <a className={`connect_btn unlockWallet ${loading.stake ? "disabled" : ""}`} onClick={!loading.stake ? handleStake : null} style={{ pointerEvents: loading.stake ? "none" : "auto", opacity: loading.stake ? 0.6 : 1 }}>
                {loading.stake ? "Processing..." : "Submit"}
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-4 col-md-4">
          <div className="farms-single-section gradient-border stakeBg" >
            ...
            <div className="unlocks " style={{ marginTop: "9.9rem" }} id="mine_now">
              <a className='connect_btn unlockWallet' id="calculate_roi_btn" onClick={!loading.roi ? handleROI : null} style={{ textAalign: "center", pointerEvents: loading.roi ? "none" : "auto", opacity: loading.roi ? 0.6 : 1}}>{loading.roi ? "Processing..." : "Calculate ROI"}</a>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-md-4">
          <div className="farms-single-section gradient-border stakeBg" >
            ...
            <div className="unlocks " >
              <a className='connect_btn unlockWallet' id="withdraw_btn" onClick={!loading.withdraw ? handleWithdraw : null} style={{ textAlign: "center", pointerEvents: loading.withdraw ? "none" : "auto", opacity: loading.withdraw ? 0.6 : 1 }}>{loading.withdraw ? "Processing..." : "Withdraw"}</a>
            </div>
          </div>
        </div>
